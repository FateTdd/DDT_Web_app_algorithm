...
//            msg.put("msg", man.getName()+">>>"+woman.getName()+","+man.getName()+" and "+woman.getName()+" is engaged " );
            msg.put("msg", ">>> "+man.getName()+" becomes engaged to "+woman.getName() );
...
//            msg.put("msg", man.getName()+">>>"+woman.getName()+","+man.getName()+" and "+woman.getName()+" is engaged ,and "+preMan.getName() +" is free." );
            msg.put("msg", ">>> "+man.getName()+" becomes engaged to "+woman.getName()+" ,and "+preMan.getName() +" becomes free." );
            msg.put("man",man.getCode());
            msg.put("woman",woman.getCode());
...
//                msg.put("msg", man.getName()+">>>"+tempWoman.getName()+","+tempWoman.getName()+" is free" );
                msg.put("msg", man.getName()+" proposes to "+tempWoman.getName()+" >>> "+tempWoman.getName()+" is free" );
                msg.put("codeLine",4);
                msg.put("colorMan",man.getCode());
...
//                msg.put("msg", man.getName()+">>>"+tempWoman.getName()+","+tempWoman.getName()+" and "+tempWoman.getPartner().getName()+" is engaged " );
                msg.put("msg", man.getName()+" proposes to "+tempWoman.getName()+" >>> "+tempWoman.getName()+" already engaged to "+tempWoman.getPartner().getName() );
                msg.put("codeLine",6);
                msg.put("colorMan",man.getCode());
                msg.put("colorWoman",tempWoman.getCode());
                Thread.sleep(1200l);
...
//                    msg1.put("msg", man.getName()+">>>"+tempWoman.getName()+","+man.getName()+"  beat "+tempWoman.getPartner().getName()+"" );
                    msg1.put("msg", ">>>" + tempWoman.getName()+" prefers "+man.getName()+" to "+tempWoman.getPartner().getName()+"" );
                    msg1.put("codeLine",8);
                    Thread.sleep(1200l);
                    sendMessage(msg1);
                    match(man,tempWoman);
...
//                    msg1.put("msg", man.getName()+">>>"+tempWoman.getName()+","+tempWoman.getPartner().getName()+"  beat "+man.getName()+"" );
                    msg1.put("msg", ">>>" + tempWoman.getName()+" prefers "+tempWoman.getPartner().getName()+"  to "+man.getName()+"" );
                    msg1.put("msg", ">>>" + tempWoman.getName()+" rejects "+man.getName()+", and "+man.getName()+" remains free" );
